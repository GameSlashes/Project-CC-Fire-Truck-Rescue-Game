    ...
    public class MinimapCamera : MonoBehaviour
    {
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            public override void OnInspectorGUI()
            {
                ...
                script.rotationOffset = EditorGUILayout.Vector3Field(new GUIContent("rotation Offset", "Description"), script.rotationOffset);
                script.myBooleanVariable = EditorGUILayout.Toggle("My Boolean Variable", script.myBooleanVariable);
        ...
        public void Update()
        {
            ...
            if (followRotationOf == FollowRotationOf.ThisGameObject)
                tempCameraObj.transform.rotation = Quaternion.Lerp(tempCameraObj.transform.rotation, Quaternion.Euler(90 + rotationOffset.x, this.gameObject.transform.rotation.eulerAngles.y + rotationOffset.y, 0 + rotationOffset.z), movementsSmoothing * Time.deltaTime);
            if (followRotationOf == FollowRotationOf.CustomGameObject && customGameObjectToFollowRotation != null)
                tempCameraObj.transform.rotation = Quaternion.Lerp(tempCameraObj.transform.rotation, Quaternion.Euler(90 + rotationOffset.x, customGameObjectToFollowRotation.rotation.eulerAngles.y + rotationOffset.y, 0 + rotationOffset.z), movementsSmoothing * Time.deltaTime);
        }
