...
public class AICharacterControl : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            RCCP_CarController carController = other.gameObject.GetComponent<RCCP_CarController>();

            if (carController != null && carController.speed >= 25f)
            {
                ...
                if (npcRigidbody != null)
                {
                    ...
                    npcRigidbody.AddForce(Vector3.forward * 500f);
                    npcRigidbody.AddForce(Vector3.up * 500f);
                }
