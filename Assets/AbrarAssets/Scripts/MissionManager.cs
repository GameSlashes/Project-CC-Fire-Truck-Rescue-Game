...
public class MissionManager : MonoBehaviour
{
    ...
    {
        public GameObject RescueManCompleteTick,fireCompleteTick, MissionCompleteText, MissionComplete, MissionFailedText, MissionFailed, LoadingScreen, Timer, ObjectivePanel, MissionCompleteRewardCoinsObj, DoubleRewardBtn, MissionInitialization, mapLine;
    ...
    public void CallitOnEnable()
    {
        ...
        flag = true;
        FireFighterManager.instance.setEndPoint = 2;
        FireFighterManager.instance.setObjectFalse = 1;
    }
